...
#
# Created: Thu Dec 12 22:51:14 2013
...
class Ui_GeoFoncierConsultation(object):
    def setupUi(self, GeoFoncierConsultation):
        ...
        GeoFoncierConsultation.resize(854, 226)
        ...
        self.label_login = QtGui.QLabel(self.dockWidgetContents)
        ...
        self.label_password = QtGui.QLabel(self.dockWidgetContents)
        ...
        self.label_zone = QtGui.QLabel(self.dockWidgetContents)
        self.label_zone.setObjectName(_fromUtf8("label_zone"))
        self.horizontalLayout.addWidget(self.label_zone)
        self.comboBox_zone = QtGui.QComboBox(self.dockWidgetContents)
        ...
        self.pushButton_listerDossiers = QtGui.QPushButton(self.dockWidgetContents)
        ...
        self.pushButton_help = QtGui.QPushButton(self.dockWidgetContents)
