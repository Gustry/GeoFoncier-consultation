...
class Ui_GeoFoncierConsultation(object):
    def setupUi(self, GeoFoncierConsultation):
        ...
        GeoFoncierConsultation.resize(860, 200)
        ...
        GeoFoncierConsultation.setMinimumSize(QtCore.QSize(684, 200))
        GeoFoncierConsultation.setAllowedAreas(QtCore.Qt.BottomDockWidgetArea|QtCore.Qt.TopDockWidgetArea)
        ...
        self.label_memoriser = QtGui.QLabel(self.formLayoutWidget)
    ...
    def retranslateUi(self, GeoFoncierConsultation):
        ...
        self.label_memoriser.setText(_translate("GeoFoncierConsultation", "Mémoriser", None))
